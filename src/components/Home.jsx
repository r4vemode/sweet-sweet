  ...
  const headerLinkGallery = (e) => {
    ...
    return (
      <div>
        <header className="header">
              ...
              <nav className={'header__nav-bar'}>
                <ul className="header-nav__list">
                  <li className="header-nav__item">
                    <a onClick={handleClickInfo} href="" className="header-nav__link">О нас</a>
                  </li>
                  <li className="header-nav__item">
                    <a onClick={headerLinkCatalog} href="" className="header-nav__link">Каталог</a>
                  </li>
                  <li className="header-nav__item">
                    <a onClick={headerLinkGallery} href="" className="header-nav__link">Галерея</a>
                  </li>
                </ul>
                ...
                <ul className="communication-list">
                  ...
                  <li className="communication-item">
                    <a href="https://api.whatsapp.com/send/?phone=79933189710&text=Здравствуйте!+Хочу+сделать+заказ" target={'_blank'} className="communication-link" rel="noreferrer">
          ...
          <section className="hero-s">
            <div className="container">
              <div className="hero__all-container">
                <div className="hero-container">
                  ...
                  <div className="hero__btn-container">
                    <a onClick={headerLinkCatalog} href="" className="hero__btn">Перейти в каталог</a>
              ...
              <div className="arrow">
                <a onClick={handleClickInfo} href="" className="header__arrow">
        ...
        <main className="main">
          <section id={'#benefits'} className="benefits-s">
            <div className="container">
                    ...
                    <div className="benefits__card-left">
                      ...
                      <div className="benefits__card-text-container">
                        <p className="benefits__card-text"><b>Кондитерская студия «ELLÍ» существует
                          в сладком мире и радует своих клиентов уже более 3-х лет.</b> Торты на любое
                          мероприятие, с поводом и без, подсластим ваше чаепитие, семейный праздник и
                          пышный банкет.</p>
                      </div>
                    </div>
          ...
          <section id={'#catalog'} className="catalog-s">
            ...
            <div className="container">
                    ...
                    <div className="catalog__card">
                      <div className="card-inner">
                        ...
                        <div className="catalog__text-container">
                          ...
                          <p className="catalog__text">Нежный медовый торт для маленькой любительницы единорогов и сезонных ягод</p>
                          <div className="price-container">
                            <p className="catalog__price">150 ₽/шт. </p>
                            <a href="https://api.whatsapp.com/send/?phone=79933189710&text=Здравствуйте!+Меня+заинтересовал+Медовик+в+виде+цифры" target={'_blank'} className="catalog__btn" rel="noreferrer">Купить сейчас</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="catalog__card">
                      <div className="card-inner">
                        ...
                        <div className="catalog__text-container">
                          ...
                          <p className="catalog__text">Торт-сердце с декором из сезонных ягод, покрытый шоколадным велюром</p>
                          <div className="price-container">
                            <p className="catalog__price">2.200₽/шт</p>
                            <a href="https://api.whatsapp.com/send/?phone=79933189710&text=Здравствуйте!+Меня+заинтересовало+Муссовое+серце" target={'_blank'} className="catalog__btn" rel="noreferrer">Купить сейчас</a>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <ul className="catalog__relative-list catalog__relative-list_mobile">
                ...
                <div className="wts__btn-container">
                  <a href="https://api.whatsapp.com/send/?phone=79933189710&text=Здравствуйте!+Хочу+сделать+заказ" target={"_blank"} className="whatsapp__btn" rel="noreferrer">Быстрый заказ через Whatsapp</a>
                </div>
            </div>
          ...
          <section className="cakes-s">
            ...
            <div className="arrow-div">
              <a href="https://instagram.com/sweets_by_elli?igshid=YzcxN2Q2NzY0OA==" target={'_blank'} className="cakes__btn"
                 onMouseEnter={handleMouseEnter}
                 onMouseLeave={handleMouseLeave} rel="noreferrer">Вся коллекция<span className={'cakes-btn-arrow'}>
...
<path d="M0.649902 267.75L117.95 153L0.649902 35.7L36.3499 0L189.35 153L36.3499 306L0.649902 267.75Z" fill={color}/>
          ...
          <section id={"#gallery"} className="gallery-s">
            ...
            <div className="container">
              <div className="footer__form-container">
                <div className="footer__form-text-container">
                  ...
                  <p className="footer-text">Мы свяжемся с вами в течении 15 минут, чтобы уточнить ваши пожелания</p>
                  <form action="" className="form-container">
                    <input type="tel" placeholder={'Номер телефона'}/>
                    <button className="footer-btn">Сделать заказ</button>
                  </form>
                </div>
              </div>
                ...
                <ul className="footer__list">
                  <li className="footer__item">
                    <div className="footer__link-container">
                      ...
                      <a href="mailto:zakazocake@gmail.com" target={'_blank'} className="footer-link" rel="noreferrer">zakazocake@gmail.com
                        | <b>«ELLI SWEETS»</b></a>
                    </div>
                  </li>
                  <li className="footer__item">
